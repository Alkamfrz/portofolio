...
export const projects = [
  ...
  },
  {
    ...
    live: 'https://garuda.kemdiktisaintek.go.id/documents/detail/5253843',
    status: 'archived',
  },
  {
    id: 'brain-tumor',
    ...
    live: 'https://ijicom.respati.ac.id/index.php/ijicom/article/view/80',
    status: 'archived',
  },
  {
    id: 'portfolio',
    title: 'Portfolio Website',
    description: 'This site — semantic Astro, editorial sidebar layout, zero runtime framework. Google Fonts, CSS custom properties.',
